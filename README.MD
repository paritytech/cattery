...
- Go 1.25+
- MongoDB
- A [GitHub App](https://docs.github.com/en/apps/creating-github-apps) with Actions read/write, Checks read and Pull requests read permissions, installed on your organization
